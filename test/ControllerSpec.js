...
describe("controller", function () {
	...
	it("should hide the content block when no todos exists", function () {
		...
		expect(view.render).toHaveBeenCalledWith("contentBlockVisibility", { visible: false });
	});
	...
	describe("toggle all", function () {
		it("should toggle all todos to active", function () {
			var todos = [
				{ id: 42, title: "my todo", complete: false },
				{ id: 43, title: "my other todo", complete: false },
			];
			setUpModel(todos);
	...
	describe("new todo", function () {
		...
		it("should add a new todo to the view", function () {
			...
			model.read.and.callFake(function (callback) {
				callback([{ title: "a new todo", completed: false }]);
			});
			...
			expect(view.render).toHaveBeenCalledWith("showEntries", [{ title: "a new todo", completed: false }]);
		});
